...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The AddPerson method was inserting at 0. I Changed this to Add instead.
    // I also added an else if check in the GetNextPerson method to handle infinite and finite turns correctly.
